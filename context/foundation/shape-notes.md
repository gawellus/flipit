...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "pain category"
      decision: "workflow friction — SR works but flashcard creation is the bottleneck"
    - topic: "insight"
      decision: "existing tools like Anki are too complex; opportunity is simplicity + AI"
    - topic: "primary persona scope"
      decision: "professionals learning new skills"
    - topic: "auth strategy"
      decision: "login (email + password / OAuth); flat user model, no roles"
    - topic: "MVP timeline"
      decision: "3 weeks after-hours; full flow including SR study session"
    - topic: "product type"
      decision: "web app"
    - topic: "target scale"
      decision: "medium (dozens to a hundred users)"
    - topic: "non-goals"
      decision: "no custom SR algorithm, no file import, no sharing/collaboration, no mobile/offline"
  frs_drafted: 10
